...
with open('data/games.txt', 'r') as f:
    for line in f.readlines():
        ...
        api_id, season_id, home_api_id, home_team_abbrev, away_api_id, away_team_abbrev, date_played, time_played, home_team_goals, away_team_goals, game_type, last_period_type = split_line
        ...
        if home_team_goals > away_team_goals:
            ...
            outcome = 0
        sql = f'''INSERT INTO games(apiId, seasonID, homeTeamID, awayTeamID, datePlayed, timePlayed, homeTeamGoals, awayTeamGoals, gameTypeID, lastPeriodTypeID, outcome)
                VALUES("{api_id}", \
                       "{season_id}", \
                       "{home_team_id}", \
                       "{away_team_id}", \
